...
function drawCat(ctx, stage, af, rest) {
  ...
  if (stage===0) {
    ...
    // Young tabby — 280 px canvas, S=14 PAD=28
    // face (ox=1 oy=2 fw=12 fh=10)
    ctx.fillStyle=O; ctx.fillRect(42,56,168,140);
    ctx.fillStyle=K; ctx.fillRect(42,56,168,14);
    ctx.fillStyle=K; ctx.fillRect(42,182,168,14);
    ctx.fillStyle=K; ctx.fillRect(42,56,14,140);
    ctx.fillStyle=K; ctx.fillRect(196,56,14,140);
    ctx.fillStyle=O; ctx.fillRect(56,70,140,112);
    ctx.fillStyle=O; ctx.fillRect(56,28,28,28);
    ctx.fillStyle=O; ctx.fillRect(168,28,28,28);
    ctx.fillStyle=K; ctx.fillRect(56,28,14,14);
    ctx.fillStyle=K; ctx.fillRect(70,28,14,14);
    ctx.fillStyle=K; ctx.fillRect(168,28,14,14);
    ctx.fillStyle=K; ctx.fillRect(182,28,14,14);
    ctx.fillStyle=P; ctx.fillRect(70,42,14,14);
    ctx.fillStyle=P; ctx.fillRect(168,42,14,14);
    ctx.fillStyle=o; ctx.fillRect(112,70,14,14);
    ctx.fillStyle=o; ctx.fillRect(126,70,14,14);
    ctx.fillStyle=o; ctx.fillRect(70,84,14,14);
    ctx.fillStyle=o; ctx.fillRect(168,84,14,14);
    if (rest) {
      ctx.fillStyle=K; ctx.fillRect(70,112,28,14);
      ctx.fillStyle=K; ctx.fillRect(154,112,28,14);
    } else if (af===1) {
      ctx.fillStyle=K; ctx.fillRect(70,112,14,14);
      ctx.fillStyle=K; ctx.fillRect(84,112,14,14);
      ctx.fillStyle=K; ctx.fillRect(154,112,14,14);
      ctx.fillStyle=K; ctx.fillRect(168,112,14,14);
    } else {
      ctx.fillStyle=W; ctx.fillRect(70,112,28,28);
      ctx.fillStyle=W; ctx.fillRect(154,112,28,28);
      ctx.fillStyle=G; ctx.fillRect(70,112,14,14);
      ctx.fillStyle=G; ctx.fillRect(84,112,14,14);
      ctx.fillStyle=G; ctx.fillRect(154,112,14,14);
      ctx.fillStyle=G; ctx.fillRect(168,112,14,14);
      ctx.fillStyle=K; ctx.fillRect(84,126,14,14);
      ctx.fillStyle=K; ctx.fillRect(168,126,14,14);
    }
    ctx.fillStyle=P; ctx.fillRect(112,140,14,14);
    ctx.fillStyle=P; ctx.fillRect(126,140,14,14);
    ctx.fillStyle=K; ctx.fillRect(98,154,14,14);
    ctx.fillStyle=K; ctx.fillRect(140,154,14,14);
    ctx.fillStyle=K; ctx.fillRect(14,140,28,14);
    ctx.fillStyle=K; ctx.fillRect(210,140,28,14);
    // body (y=12–14, 3 rows)
    ctx.fillStyle=O; ctx.fillRect(42,196,196,42);
    ctx.fillStyle=K; ctx.fillRect(42,196,196,14);
    ctx.fillStyle=K; ctx.fillRect(42,224,196,14);
    ctx.fillStyle=K; ctx.fillRect(42,196,14,42);
    ctx.fillStyle=K; ctx.fillRect(224,196,14,42);
    ctx.fillStyle=O; ctx.fillRect(56,210,168,14);
    ctx.fillStyle=o; ctx.fillRect(70,210,28,14);
    ctx.fillStyle=o; ctx.fillRect(126,210,28,14);
    ctx.fillStyle=o; ctx.fillRect(182,210,28,14);
    // paws (y=14)
    ctx.fillStyle=o; ctx.fillRect(56,224,42,14);
    ctx.fillStyle=o; ctx.fillRect(182,224,42,14);
    // tail (x=14–15, y=10–14)
    ctx.fillStyle=o; ctx.fillRect(224,168,28,70);
    ctx.fillStyle=o; ctx.fillRect(210,224,42,14);
    ctx.fillStyle=K; ctx.fillRect(224,168,14,14);
    ctx.fillStyle=K; ctx.fillRect(238,224,14,14);
    ctx.fillStyle=P; ctx.fillRect(238,238,14,14);
  } else if (stage===5) {
    // Confident tabby — 280 px canvas, S=14 PAD=28
    // face (ox=1 oy=2 fw=12 fh=10)
    ctx.fillStyle=O; ctx.fillRect(42,56,168,140);
    ctx.fillStyle=K; ctx.fillRect(42,56,168,14);
    ctx.fillStyle=K; ctx.fillRect(42,182,168,14);
    ...
    ctx.fillStyle=K; ctx.fillRect(210,140,28,14);
    // body (y=12–15, 4 rows)
    ctx.fillStyle=O; ctx.fillRect(42,196,196,56);
    ctx.fillStyle=K; ctx.fillRect(42,196,196,14);
    ctx.fillStyle=K; ctx.fillRect(42,238,196,14);
    ctx.fillStyle=K; ctx.fillRect(42,196,14,56);
    ctx.fillStyle=K; ctx.fillRect(224,196,14,56);
    ctx.fillStyle=O; ctx.fillRect(56,210,168,28);
    ctx.fillStyle=o; ctx.fillRect(56,210,42,14);
    ctx.fillStyle=o; ctx.fillRect(112,210,42,14);
    ctx.fillStyle=o; ctx.fillRect(168,210,42,14);
    ctx.fillStyle=o; ctx.fillRect(70,224,42,14);
    ctx.fillStyle=o; ctx.fillRect(154,224,42,14);
    // paws (y=15)
    ctx.fillStyle=o; ctx.fillRect(56,238,42,14);
    ctx.fillStyle=o; ctx.fillRect(182,238,42,14);
    // tail (left side, animated)
    if (af===0) {
      ctx.fillStyle=o; ctx.fillRect(28,182,14,70);
      ctx.fillStyle=K; ctx.fillRect(28,182,14,14);
      ctx.fillStyle=K; ctx.fillRect(28,238,14,14);
      ctx.fillStyle=P; ctx.fillRect(28,168,14,14);
    } else {
      ctx.fillStyle=o; ctx.fillRect(28,168,14,70);
      ctx.fillStyle=K; ctx.fillRect(28,168,14,14);
      ctx.fillStyle=K; ctx.fillRect(28,224,14,14);
      ctx.fillStyle=P; ctx.fillRect(28,154,14,14);
    }
  } else if (stage===6) {
    // Striped tabby — 280 px canvas, S=14 PAD=28
    // face (ox=1 oy=2 fw=12 fh=10)
    ctx.fillStyle=O; ctx.fillRect(42,56,168,140);
    ctx.fillStyle=K; ctx.fillRect(42,56,168,14);
    ctx.fillStyle=K; ctx.fillRect(42,182,168,14);
    ...
    ctx.fillStyle=K; ctx.fillRect(224,196,14,56);
    ctx.fillStyle=O; ctx.fillRect(56,210,168,28);
    ctx.fillStyle=W; ctx.fillRect(98,210,84,28);
    ctx.fillStyle=o; ctx.fillRect(56,210,28,14);
    ctx.fillStyle=o; ctx.fillRect(196,210,28,14);
    ctx.fillStyle=o; ctx.fillRect(56,224,28,14);
    ctx.fillStyle=o; ctx.fillRect(196,224,28,14);
    ctx.fillStyle=o; ctx.fillRect(84,210,14,14);
    ctx.fillStyle=o; ctx.fillRect(182,210,14,14);
    // paws (y=15)
    ctx.fillStyle=o; ctx.fillRect(56,238,42,14);
    ctx.fillStyle=o; ctx.fillRect(182,238,42,14);
    // tail (right side, hooked)
    ctx.fillStyle=o; ctx.fillRect(224,168,28,56);
    ctx.fillStyle=o; ctx.fillRect(210,210,28,14);
    ctx.fillStyle=K; ctx.fillRect(224,168,14,14);
    ctx.fillStyle=K; ctx.fillRect(224,210,14,14);
    ctx.fillStyle=P; ctx.fillRect(238,154,14,14);
  } else if (stage===7) {
    ...
    ctx.fillStyle=o; ctx.fillRect(70,84,14,14);
    ctx.fillStyle=o; ctx.fillRect(168,84,14,14);
    ctx.fillStyle=o; ctx.fillRect(84,84,28,14);
    ctx.fillStyle=o; ctx.fillRect(140,84,28,14);
    if (rest) {
      ctx.fillStyle=K; ctx.fillRect(70,112,28,14);
      ctx.fillStyle=K; ctx.fillRect(154,112,28,14);
    } else if (af===1) {
    ...
    ctx.fillStyle=K; ctx.fillRect(210,140,28,14);
    // body y=12-16
    ctx.fillStyle=O; ctx.fillRect(42,196,196,70);
    ctx.fillStyle=K; ctx.fillRect(42,196,196,14);
    ctx.fillStyle=K; ctx.fillRect(42,252,196,14);
    ctx.fillStyle=K; ctx.fillRect(42,196,14,70);
    ctx.fillStyle=K; ctx.fillRect(224,196,14,70);
    ctx.fillStyle=O; ctx.fillRect(56,210,168,42);
    ctx.fillStyle=W; ctx.fillRect(98,210,84,28);
    ctx.fillStyle=o; ctx.fillRect(56,210,28,14);
    ctx.fillStyle=o; ctx.fillRect(196,210,28,14);
    ctx.fillStyle=o; ctx.fillRect(56,224,28,14);
    ...
    ctx.fillStyle=o; ctx.fillRect(84,210,14,14);
    ctx.fillStyle=o; ctx.fillRect(182,210,14,14);
    ctx.fillStyle=o; ctx.fillRect(84,224,14,14);
    ctx.fillStyle=o; ctx.fillRect(182,224,14,14);
    // paws y=15
    ctx.fillStyle=o; ctx.fillRect(56,238,42,14);
    ctx.fillStyle=o; ctx.fillRect(182,238,42,14);
    ctx.fillStyle=W; ctx.fillRect(70,238,14,14);
    ctx.fillStyle=W; ctx.fillRect(196,238,14,14);
    // tail x=14-15, y=9-15
    ctx.fillStyle=o; ctx.fillRect(224,154,28,98);
    ctx.fillStyle=o; ctx.fillRect(210,238,42,14);
    ctx.fillStyle=K; ctx.fillRect(224,154,14,14);
    ctx.fillStyle=K; ctx.fillRect(238,238,14,14);
    ctx.fillStyle=P; ctx.fillRect(224,238,14,14);
  } else if (stage===8) {
    ...
    ctx.fillStyle=K; ctx.fillRect(224,196,14,56);
    ctx.fillStyle=O; ctx.fillRect(56,210,168,28);
    ctx.fillStyle=W; ctx.fillRect(84,210,112,14);
    ctx.fillStyle=o; ctx.fillRect(56,210,14,14);
    ctx.fillStyle=o; ctx.fillRect(210,210,14,14);
    ctx.fillStyle=o; ctx.fillRect(56,224,42,14);
    ctx.fillStyle=o; ctx.fillRect(98,224,28,14);
    ctx.fillStyle=o; ctx.fillRect(154,224,28,14);
    ctx.fillStyle=o; ctx.fillRect(182,224,42,14);
    // paws y=15
    ctx.fillStyle=o; ctx.fillRect(56,238,42,14);
    ctx.fillStyle=o; ctx.fillRect(182,238,42,14);
    ctx.fillStyle=W; ctx.fillRect(70,238,14,14);
    ctx.fillStyle=W; ctx.fillRect(84,238,14,14);
    ctx.fillStyle=W; ctx.fillRect(196,238,14,14);
    ctx.fillStyle=W; ctx.fillRect(210,238,14,14);
    // tail animated: af===0 x=13, af===1 x=14
    if (af===0) {
      ctx.fillStyle=o; ctx.fillRect(210,168,28,84);
      ctx.fillStyle=K; ctx.fillRect(210,168,14,14);
      ctx.fillStyle=K; ctx.fillRect(224,238,14,14);
      ctx.fillStyle=P; ctx.fillRect(224,154,14,14);
    } else {
      ctx.fillStyle=o; ctx.fillRect(224,168,28,84);
      ctx.fillStyle=K; ctx.fillRect(224,168,14,14);
      ctx.fillStyle=K; ctx.fillRect(238,238,14,14);
      ctx.fillStyle=P; ctx.fillRect(238,154,14,14);
    }
    ...
    ctx.fillStyle=K; ctx.fillRect(224,196,14,56);
    ctx.fillStyle=O; ctx.fillRect(56,210,168,28);
    ctx.fillStyle=W; ctx.fillRect(84,210,112,28);
    ctx.fillStyle=o; ctx.fillRect(56,210,28,14);
    ctx.fillStyle=o; ctx.fillRect(196,210,28,14);
    ctx.fillStyle=o; ctx.fillRect(56,224,28,14);
    ctx.fillStyle=o; ctx.fillRect(196,224,28,14);
    ...
    ctx.fillStyle=o; ctx.fillRect(182,224,14,14);
    // paws y=15
    ctx.fillStyle=o; ctx.fillRect(42,238,56,14);
    ctx.fillStyle=o; ctx.fillRect(182,238,56,14);
    ctx.fillStyle=O; ctx.fillRect(56,238,14,14);
    ctx.fillStyle=O; ctx.fillRect(70,238,14,14);
    ctx.fillStyle=O; ctx.fillRect(196,238,14,14);
    ctx.fillStyle=O; ctx.fillRect(210,238,14,14);
    // tail x=13-15, y=9-15
    ctx.fillStyle=o; ctx.fillRect(210,154,42,98);
    ctx.fillStyle=o; ctx.fillRect(196,238,56,28);
    ctx.fillStyle=K; ctx.fillRect(210,154,14,14);
    ctx.fillStyle=K; ctx.fillRect(238,238,14,14);
    ctx.fillStyle=P; ctx.fillRect(238,112,14,14);
...
export function drawPet(ctx, petId, stage, animFrame, isResting) {
  ...
  S = Math.max(1, Math.floor(size * 0.85 / 16));
